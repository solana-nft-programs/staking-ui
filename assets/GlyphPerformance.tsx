...
export const GlyphPerformance: React.FC<Props> = ({ color }: Props) => (
  <svg
    width="68"
    height="68"
    viewBox="0 0 68 68"
  ...
  >
    <path
      ...
      fill={color ?? 'white'}
    />
    <circle cx="34" cy="34" r="33" stroke="#8D8B9B" strokeWidth="2" />
    <g clipPath="url(#clip0_628_15375)">
      <path
        d="M46 22H22V46H46V22Z"
        fill={color ?? 'white'}
        fillOpacity="0.01"
      />
      <path
