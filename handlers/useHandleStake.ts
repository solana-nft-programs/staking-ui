import { executeTransactionSequence, logError } from '@solana-nft-programs/common'
import { stake as stakeV2 } from '@solana-nft-programs/rewards-center'
import { stakeAll } from '@solana-nft-programs/staking'
