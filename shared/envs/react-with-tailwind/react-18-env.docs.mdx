...
To configure this env for a component (or group of components) via the CLI, run `bit env set "some/*/glob/pattern/**" cardinal-labs.shared/envs/react-with-tailwind`.
...
```json
{
  "teambit.workspace/variants": {
    "{ui/**}, {pages/**}": {
      "cardinal-labs.shared/envs/react-with-tailwind": {}
    }
  }
}
```
...
```bash
bit fork cardinal-labs.shared/envs/react-with-tailwind <your-env-name>
```
