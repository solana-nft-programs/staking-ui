    ...
    async resolve() {
        for (let k = 0; k < this._idlIx.accounts.length; k += 1) {
            ...
            switch (accountDescName) {
                case "systemProgram":
                    if (this._accounts[accountDescName] === undefined) {
                        this._accounts[accountDescName] = web3_js_1.SystemProgram.programId;
                    }
                case "rent":
                    if (this._accounts[accountDescName] === undefined) {
                        this._accounts[accountDescName] = web3_js_1.SYSVAR_RENT_PUBKEY;
                    }
                case "tokenProgram":
                    if (this._accounts[accountDescName] === undefined) {
                        this._accounts[accountDescName] = token_js_1.TOKEN_PROGRAM_ID;
                    }
                case "associatedTokenProgram":
                    if (this._accounts[accountDescName] === undefined) {
                        this._accounts[accountDescName] = token_js_1.ASSOCIATED_PROGRAM_ID;
                    }
            }
        }
    }
