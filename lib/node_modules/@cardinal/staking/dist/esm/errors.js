...
programIdls = [
    ...
    const hex = e.message.split(" ").at(-1);
    const dec = parseInt(hex || "", 16);
    const logs = (_c = (_b = (_a = e.logs) !== null && _a !== void 0 ? _a : [
        e.message,
    ]) !== null && _b !== void 0 ? _b : [e.toString()]) !== null && _c !== void 0 ? _c : [];
    const matchedErrors = dec
        ? [
            ...programIdls.map(({ idl, programId }) => {
                var _a, _b;
                return ({
                    // match program on any log that includes programId and 'failed'
                    programMatch: logs === null || logs === void 0 ? void 0 : logs.some((l) => l.includes(programId.toString()) && l.includes("failed")),
            ...
            }),
            {
                ...
                errorMatch: (_d = nativeErrors.find((err) => err.code === dec.toString())) === null || _d === void 0 ? void 0 : _d.message,
            },
        ]
        : [
            ...programIdls.map(({ idl, programId }) => {
                ...
                return ({
                    ...
                    errorMatch: (_b = (_a = idl.errors) === null || _a === void 0 ? void 0 : _a.find((err) => {
                        ...
                        return e.message.includes(err.code.toString()) ||
                            // toString includes error
                            e.toString().includes(err.code.toString()) ||
                            (
                            // any log includes error
                            (_a = e.logs) === null || _a === void 0 ? void 0 : _a.some((l) => l.toString().includes(err.code.toString())));
                    })) === null || _b === void 0 ? void 0 : _b.msg,
                });
            }),
            {
                errorMatch: (_e = nativeErrors.find((err) => {
                    var _a;
                    // message includes error
                    return e.message.includes(err.code) ||
                        // toString includes error
                        e.toString().includes(err.code) ||
                        (
                        // any log includes error
                        (_a = e.logs) === null || _a === void 0 ? void 0 : _a.some((l) => l.toString().includes(err.code)));
                })) === null || _e === void 0 ? void 0 : _e.message,
            },
        ];
    return (((_f = matchedErrors.find((e) => e.programMatch && e.errorMatch)) === null || _f === void 0 ? void 0 : _f.errorMatch) ||
        ((_g = matchedErrors.find((e) => e.errorMatch)) === null || _g === void 0 ? void 0 : _g.errorMatch) ||
        fallBackMessage);
};
