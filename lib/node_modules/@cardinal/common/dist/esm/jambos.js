...
export function getActiveStakeSeconds(stakeEntryData, UTCNow) {
    ...
    const stakeBoost = ((stakeEntryData === null || stakeEntryData === void 0 ? void 0 : stakeEntryData.parsed.stakeBoost) || new BN(1)).toNumber();
    const totalStakeSeconds = ((stakeEntryData === null || stakeEntryData === void 0 ? void 0 : stakeEntryData.parsed.totalStakeSeconds) || new BN(0)).toNumber();
