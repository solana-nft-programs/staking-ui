  ...
  return (
    <div>
      <Head>
        <title>
          {`${
            stakePoolMetadata ? stakePoolMetadata.displayName : 'Kureiji turtlez'
          } Staking UI`}
        </title>
        <meta name="description" content="Generated by The|wizard|tech Staking UI" />
        <link
          rel="icon"
        ...
        <div className="my-2 h-full min-h-[55vh] rounded-md bg-white bg-opacity-5 p-10 text-gray-200">
          {!stakePool.isFetched || !rewardDistributor.isFetched ? (
            ...
            <div className="w-full text-center text-gray-500">
              Stake pool Available after mint
            </div>
          )}
        </div>
      </div>
