  ...
  return (
    ...
    <Head>
      ...
      >
        ...
        {
           // @ts-ignore
          (tokenData.data) && Object.keys(tokenData.data).length > 0 &&
          // @ts-ignore
          !(Object.keys(tokenData.data).includes('error')) ? (
            ...
            > 
              ...
              (Object.keys(tokenData.data.info)).includes('delegate') ? (
                <div className="mx-5 mb-5 rounded-md border-[1px] bg-opacity-40 p-4 text-center text-lg font-semibold"
                style={{
                  background:
                    stakePoolMetadata?.colors?.accent || defaultSecondaryColor,
